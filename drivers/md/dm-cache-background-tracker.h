 ...
 *
 * There is no locking in this, so calls will probably need to be protected
 * with a spin lock.
 */
...
/*
 * Desetroy the tracker.  No issued, but not complete work should
 ...
 * is not NULL then it will be set to point to the trackers internal
 * copy of the work.
 *
